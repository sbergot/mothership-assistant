  ...
  return (
    <>
      <div className="flex gap-2">
        ...
        <div
          className={`transition-all max-w-[calc(100vw-4rem)] right-part-width lg:max-w-[calc(100vw - 50rem)] w-full h-[calc(100dvh-1rem)] fixed bottom-2 right-6 border-2 rounded-3xl p-4 mb-2 border-mother-5 bg-white ${visibilityClasses}`}
        >
          {rightPart}
        </div>
      </div>
